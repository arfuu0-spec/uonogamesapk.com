...
export default function Store() {
    ...
    telegram: isDefaultView && en("telegram") && tg.enabled !== false ? (
      <a key="telegram" href={tg.link || "https://t.me/"} target="_blank" rel="noopener noreferrer" data-testid="telegram-cta"
        ...
        <div className="flex-1">
          <p className="font-display text-sm font-bold text-[#111111]">{tg.cta_text || "Join our Telegram"} ✈️</p>
  ...
  return (
    <div className="app-shell pb-10 bg-[#FAFAFA] text-[#111111] min-h-screen relative">
      ...
      {hero.enabled !== false && (
        <div className="px-4 pt-3">
          <div className="overflow-hidden rounded-[20px] border border-[#E5E7EB] shadow-[0_10px_30px_rgba(0,0,0,0.1)] bg-white" data-testid="hero-banner">
            <OptimizedImage 
